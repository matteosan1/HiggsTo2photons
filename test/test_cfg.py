# original version produced by job_maker on Fri Mar  7 14:25:03 2014
# command:
#   job_maker --MC --AOD --caf --noskim --name=test --datasetpath=TEST --globaltag=START70_V6::All
...
#ADDITIONAL OPTIONS
flagAOD = 'ON'
jobMaker = 'job_maker --MC --AOD --caf --noskim --name=test --datasetpath=TEST --globaltag=START70_V6::All'
...
process.load("HiggsAnalysis.HiggsTo2photons.h2ganalyzer_71X_cfi")
...
process.calibratedElectrons.inputElectronsTag = cms.InputTag("gedGsfElectrons")
...
process.eleRegressionEnergy.inputElectronsTag = cms.InputTag('gedGsfElectrons')
...
process.eleRegressionEnergy.rhoCollection = cms.InputTag("fixedGridRhoFastjetAll")
...
process.p11 = cms.Path(process.eventCounters*process.eventFilter1*process.calibratedElectronsSequence)
