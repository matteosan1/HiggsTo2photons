...
h2ganalyzer = cms.EDAnalyzer(
    ...
    ElectronColl  = cms.InputTag("gedGsfElectrons"),        
    ...
    PhotonCollStd = cms.InputTag("gedPhotons"),
    ...
    rhoCollection_algo1 = cms.InputTag("fixedGridRhoFastjetAll",""),
    ...
    PFMETTYPE1Coll = cms.InputTag("pfMet"),
